...
Note: Visual Studio 2012 is supported (VS2012 Express only with workarounds for T4 template processing). When using VS2012 please install [VC++ 2013 redists](https://www.microsoft.com/en-us/download/details.aspx?id=40784).
