                ...
                if(supportedDevice)
                {
                    ...
                    if (adapter.Outputs.Length == 0)
                    {
                        ...
                        if (fallbackDisplayModes == null || fallbackDisplayModeList == null)
                        {
                            ...
                            {
                                new MyDisplayMode(640, 480, 60),
                                new MyDisplayMode(720, 576, 60),
                                new MyDisplayMode(800, 600, 60),
                                new MyDisplayMode(1024, 768, 60),
                                new MyDisplayMode(1152, 864, 60),
                                new MyDisplayMode(1280, 720, 60),
                                new MyDisplayMode(1280, 768, 60),
                                new MyDisplayMode(1280, 800, 60),
                                new MyDisplayMode(1280, 960, 60),
                                new MyDisplayMode(1280, 1024, 60),
                                new MyDisplayMode(1360, 768, 60),
                                new MyDisplayMode(1360, 1024, 60),
                                new MyDisplayMode(1440, 900, 60),
                                new MyDisplayMode(1600, 900, 60),
                                new MyDisplayMode(1600, 1024, 60),
                                new MyDisplayMode(1600, 1200, 60),
                                new MyDisplayMode(1680, 1200, 60),
                                new MyDisplayMode(1680, 1050, 60),
                                new MyDisplayMode(1920, 1080, 60),
                                new MyDisplayMode(1920, 1200, 60),
                            };                            // FALLBACK MODES
