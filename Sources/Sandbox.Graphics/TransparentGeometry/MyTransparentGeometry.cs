...
namespace Sandbox.Graphics.TransparentGeometry
{
    using VRageRender;
    ...
    public class MyTransparentGeometry
    {
        ...
        //static MyObjectsPoolSimple<VRageRender.MyBillboard> m_preallocatedBillboards = new MyObjectsPoolSimple<VRageRender.MyBillboard>(MyTransparentGeometryConstants.MAX_TRANSPARENT_GEOMETRY_COUNT / 2);   //  Billboards that survive only 1 draw call (dust, reflector, ...)
        //static MyObjectsPoolSimple<VRageRender.MyBillboard> m_preallocatedParticleBillboards = new MyObjectsPoolSimple<VRageRender.MyBillboard>(MyTransparentGeometryConstants.MAX_TRANSPARENT_GEOMETRY_COUNT / 2);   //  Billboards that survive only 1 draw call (dust, reflector, ...)

        //static List<VRageRender.MyBillboard> m_sortedTransparentGeometry = new List<VRageRender.MyBillboard>(MyTransparentGeometryConstants.MAX_TRANSPARENT_GEOMETRY_COUNT); //  Used for drawing sorted particles
        //static List<VRageRender.MyBillboard> m_preparedTransparentGeometry = new List<VRageRender.MyBillboard>(MyTransparentGeometryConstants.MAX_TRANSPARENT_GEOMETRY_COUNT);
        //static List<VRageRender.MyBillboard> m_lowresTransparentGeometry = new List<VRageRender.MyBillboard>(MyTransparentGeometryConstants.MAX_TRANSPARENT_GEOMETRY_COUNT);
        ...
        public static void AddTriangleBillboard(
            ...
            int priority = 0, bool colorize = false, bool useNormals = false)
        {
