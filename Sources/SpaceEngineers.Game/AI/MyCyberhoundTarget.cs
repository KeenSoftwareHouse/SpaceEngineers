...
{
    [TargetType("Cyberhound")]
    [StaticEventOwner]
    public class MyCyberhoundTarget : MyAiTargetBase
    {
        ...
        private static readonly int ATTACK_DAMAGE_TO_CHARACTER = 12;
            // Cyberhound attack (Cyberhound damage) to character

        private static readonly int ATTACK_DAMAGE_TO_GRID = 8; // Cyberhound attack (Cyberhound damage) to grid
                        ...
                        foreach (var hitEntity in hitEntities)
                        {
                            ...
                            if (hitEntity is MyCharacter && hitEntity != botEntity)
                            {
                                ...
                                if (character.IsDead)
                                {
                                    ...
                                    if (cyberhoundInventory == null) continue;
