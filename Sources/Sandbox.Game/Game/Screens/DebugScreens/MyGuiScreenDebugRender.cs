...
{
    [MyDebugScreen("Render", "Overall settings")]
    class MyGuiScreenDebugRender : MyGuiScreenDebugBase
    {
        ...
        public override void RecreateControls(bool constructor)
        {
            ...
            AddSlider("Lod near distance", 0.0f, 2000.0f, profile, MemberHelper.GetMember(() => profile.LodTransitionDistanceNear));
            AddSlider("Lod far distance", 0.0f, 2000.0f, profile, MemberHelper.GetMember(() => profile.LodTransitionDistanceFar));
            AddSlider("Lod background start", 0.0f, 5000.0f, profile, MemberHelper.GetMember(() => profile.LodTransitionDistanceBackgroundStart));
            if (MySector.MainCamera != null)
            {
                AddSlider("Lod background end", MySector.MainCamera.NearPlaneDistance + 1, 50000.0f, profile, MemberHelper.GetMember(() => profile.LodTransitionDistanceBackgroundEnd));
