...
{
    [MyDebugScreen("Render", "Image settings")]
    class MyGuiScreenDebugRender4 : MyGuiScreenDebugBase
    {
        public MyGuiScreenDebugRender4()
        {
        ...
        public override void RecreateControls(bool constructor)
        {
            ...
            AddSlider("MiddleGreyCurveSharpness", 1.0f, 5.0f, () => MyPostprocessSettingsWrapper.Settings.MiddleGreyCurveSharpness, (float f) => MyPostprocessSettingsWrapper.Settings.MiddleGreyCurveSharpness = f);
