...
{
    [MyDebugScreen("Render", "Outdoor rendering settings")]
    class MyGuiScreenDebugRender3 : MyGuiScreenDebugBase
    {
        ...
        public override void RecreateControls(bool constructor)
        {
            ...
            AddSlider("Prostprocess close distance", 0.0f, 200.0f, MyRenderProxy.Settings, MemberHelper.GetMember(() => MyRenderProxy.Settings.GrassPostprocessCloseDistance));
