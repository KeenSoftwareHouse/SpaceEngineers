...
namespace Sandbox.Game.Gui
{
    ...
    class MyGuiScreenDebugImageProcessing : MyGuiScreenDebugBase
    {
        ...
        public override void RecreateControls(bool constructor)
        {
            ...
            AddSlider("Constant Luminance", 0.0001f, 0.5f, () => MyPostprocessSettingsWrapper.Settings.ConstantLuminance, (float f) => MyPostprocessSettingsWrapper.Settings.ConstantLuminance = f);
