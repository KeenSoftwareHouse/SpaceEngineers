...
{
    [MyDebugScreen("Render", "Shadow settings")]
    class MyGuiScreenDebugRenderShadows : MyGuiScreenDebugBase
    {
        ...
        public override void RecreateControls(bool constructor)
        {
			...
			AddSlider("Max base shadow cascade distance", 1.0f, 10000.0f, MyRenderProxy.Settings, MemberHelper.GetMember(() => MyRenderProxy.Settings.ShadowCascadeMaxDistance));
