...
namespace Sandbox.Game.Replication
{
    ...
    class MyStreamingEntityStateGroup<T> : IMyStateGroup where T : IMyStreamableReplicable
    {
        ...
        public MyStreamingEntityStateGroup(T obj)
        {
            Instance = obj;
        }
        ...
        SortedList<StreamPartInfo, byte[]> m_recivedParts;

        short m_numPartsToRecive = 0;
    
        int m_recievedBytes = 0;

        int m_uncompressedSize = 0;

        public StateGroupEnum GroupType
        {
            get { return StateGroupEnum.Streamining; }
        }
