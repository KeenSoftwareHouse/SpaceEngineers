...
{
    public static partial class MyWorldGenerator
    {
        public struct Args
        {
        ...
        public static void LoadPregeneratedAsteroids(ref Args args)
        {
        ...
        // Backward compatibility method only used when the procedurally generated asteroids were not working
        private static void AddPregeneratedCluster(ref Args args, string name, float scale)
        {
        ...
        private static void AddPregeneratedAsteroid(string name, float scale)
        {
            ...
            AddAsteroidPrefab("Pregen\\" + name, position, name);
        }

        private static void AddAsteroidPrefab(string prefabName, Vector3 position, string name)
        {
