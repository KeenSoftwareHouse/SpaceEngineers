...
{
    [MyDefinitionType(typeof(MyObjectBuilder_CraftingComponentInteractiveDefinition))]
    public class MyCraftingComponentInteractiveDefinition : MyComponentDefinitionBase
    {
        ...
        protected override void Init(MyObjectBuilder_DefinitionBase builder)
        {
            ...
            var ob = builder as MyObjectBuilder_CraftingComponentInteractiveDefinition;
