...
{
    class MyDrawTechniqueMeshInstancedGeneric : MyDrawTechniqueBaseDNS
    {
        public override MyEffectBase PrepareAndBeginShader(MyRender.MyRenderSetup setup, MyLodTypeEnum lodType)
        {
            ...
            shader.SetTechnique(MyRenderConstants.RenderQualityProfile.ModelsInstancedGenericTechnique);
