...
namespace VRageRender.Graphics
{
    ...
    internal class DepthStencilState : MyRenderComponentBase, IDisposable
    {
        ...
        public static DepthStencilState BackgroundAtmosphereObjects
        {
            get
            {
                if (backgroundAtmosphereState == null)
                {
                    backgroundAtmosphereState = new DepthStencilState()
                    {
                        DepthBufferEnable = true,
                        DepthBufferWriteEnable = true,
                        DepthBufferFunction = Compare.LessEqual,
                ...
                return backgroundAtmosphereState;
            }
        }

        static DepthStencilState backgroundAtmospherePlanetSurfaceState;

        public static DepthStencilState BackgroundAtmospherePlanetSurfaceState
        {
            get
            {
                if (backgroundAtmospherePlanetSurfaceState == null)
                {
                    backgroundAtmospherePlanetSurfaceState = new DepthStencilState()
                    {
                        DepthBufferEnable = false,
                        DepthBufferWriteEnable = false,
                        DepthBufferFunction = Compare.LessEqual,
                ...
                return backgroundAtmospherePlanetSurfaceState;
            }
        }
