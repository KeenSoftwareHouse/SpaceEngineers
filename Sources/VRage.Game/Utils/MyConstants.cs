...
// VRAGE TODO: Rename namespace and split constants to separate games!
...
namespace VRage.Game
{
    public static class MyConstants
    {
        ...
        public static float DEFAULT_GROUND_SEARCH_DISTANCE = 2.0f;//m
        public static float FLOATING_OBJ_INTERACTIVE_DISTANCE = 3f;//m
    ...
    public static class MyMainMenuConstants
    {
...
//        public const float MISSILE_BACKKICK = 700;
    ...
    {
        public static string URL_GUIDE_DEFAULT = "https://youtu.be/DQg6mpjQMRo";
